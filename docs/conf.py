...
# -*- coding: utf-8 -*-
#
# awsenergylabelerlib documentation build configuration file, created by
# sphinx-quickstart
#
...
sphinx.ext.apidoc.main(argv=['-f', '-o', os.path.join(project_root, 'docs'),
                             os.path.join(project_root, '''awsenergylabelerlib''')])
...
version = awsenergylabelerlib.__version__
# The full version, including alpha/beta/rc tags.
release = awsenergylabelerlib.__version__
...
htmlhelp_basename = '''awsenergylabelerlibdoc'''
