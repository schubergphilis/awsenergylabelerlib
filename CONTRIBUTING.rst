...
Ready to contribute? Here's how to set up `awsenergylabelerlib` for local development.
Using of pipenv is highly recommended.

1. Clone your fork locally::

    $ git clone ghttps://github.com/schubergphilis/awsenergylabelerlib.git
